...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/06/2024 às 21:25
...
--
-- Banco de dados: `sistema_ouvidoria`
--
...
--
-- Estrutura para tabela `servico_afetado`
--

CREATE TABLE `servico_afetado` (
  `id_servico` int(11) NOT NULL,
  `nome_servico` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Despejando dados para a tabela `servico_afetado`
--
...
CREATE TABLE `tipo_ouvidoria` (
  ...
  `nome_tipo` varchar(11) DEFAULT NULL,
  `descricao_tipo` varchar(701) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Despejando dados para a tabela `tipo_ouvidoria`
--

INSERT INTO `tipo_ouvidoria` (`id_tipo`, `nome_tipo`, `descricao_tipo`) VALUES
...
ALTER TABLE `anexo`
  ...
  ADD KEY `cod_ouvidoria` (`cod_ouvidoria`);
...
--
-- Índices de tabela `servico_afetado`
--
...
--
ALTER TABLE `anexo`
  ADD CONSTRAINT `anexo_ibfk_1` FOREIGN KEY (`cod_ouvidoria`) REFERENCES `ouvidoria` (`id_ouvidoria`);
...
--
ALTER TABLE `ouvidoria`
  ADD CONSTRAINT `ouvidoria_ibfk_1` FOREIGN KEY (`cod_tipo`) REFERENCES `tipo_ouvidoria` (`id_tipo`),
  ADD CONSTRAINT `ouvidoria_ibfk_2` FOREIGN KEY (`cod_servico`) REFERENCES `servico_afetado` (`id_servico`),
  ADD CONSTRAINT `ouvidoria_ibfk_3` FOREIGN KEY (`cod_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Restrições para tabelas `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`cod_cidade`) REFERENCES `cidade` (`id_cidade`);
COMMIT;
